...
import sys
# from data.example_datasets5.process_3000data import train_file, test_file, dev_file
...
class Configer:
    def __init__(self, config_file='system.config'):
        ...
        the_item = 'testr_file'
        if the_item in config:
            self.testr_file = config[the_item]
        the_item = 'trainr_file'
        if the_item in config:
            self.trainr_file = config[the_item]
        the_item = 'devr_file'
        if the_item in config:
            self.devr_file = config[the_item]
        the_item = 'delimiter'
        if the_item in config:
        ...
        the_item = 'use_CNN'
        if the_item in config:
            self.use_CNN = self.str2bool(config[the_item])
        ...
        the_item = 'cnn_layers'
        if the_item in config:
            self.cnn_layers = config[the_item]
        the_item = 'cnn_filter_width'
        if the_item in config:
            self.cnn_filter_width = int(config[the_item])
        the_item = 'cnn_num_filter'
        if the_item in config:
            self.cnn_num_filter = int(config[the_item])
        the_item = 'cnn_output_width'
        if the_item in config:
            self.cnn_output_width = int(config[the_item])
        the_item = 'cnn_repeat_times'
        if the_item in config:
            self.cnn_repeat_times = int(config[the_item])
        ...
        the_item = 'output_file'
        if the_item in config:
            self.output_file = config[the_item]
        the_item = 'nolable_output_test_file'
        if the_item in config:
            self.nolable_output_test_file = config[the_item]
        ...
        the_item = 'is_real_output_sentence_entity'
        if the_item in config:
            self.is_real_output_sentence_entity = self.str2bool(config[the_item])
        the_item = 'real_output_sentence_entity_file'
        if the_item in config:
            self.real_output_sentence_entity_file = config[the_item]
        the_item = 'is_compare_output_sentence_entity'
        if the_item in config:
            self.is_compare_output_sentence_entity = self.str2bool(config[the_item])
        the_item = 'compare_output_sentence_entity_file'
        if the_item in config:
            self.compare_output_sentence_entity_file = config[the_item]
        the_item = 'is_real_test'
        if the_item in config:
            self.is_real_test = self.str2bool(config[the_item])
        the_item = 'is_nolable_output_sentence_entity'
        if the_item in config:
            self.is_nolable_output_sentence_entity = self.str2bool(config[the_item])
        the_item = 'nolable_output_sentence_entity_file'
        if the_item in config:
            self.nolable_output_sentence_entity_file = config[the_item]
