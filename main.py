...
from engines.BiLSTM_CNN_CRFS import BiLSTM_CNN_CRFs
...
def predict_single(model, sentence):
    sentence_tokens, entitiesentities_type, entities_index = model.predict_single(sentence)
...
if __name__ == "__main__":
    ...
    if mode == 'api_service':
        ...
        model = BiLSTM_CNN_CRFs(configs, logger, dataManager)
        if mode == 'train':
